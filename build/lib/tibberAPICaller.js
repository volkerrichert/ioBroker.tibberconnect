    ...
    async updateHomesFromAPI() {
        ...
        for (const homeIndex in currentHomes) {
            ...
            await Promise.all([
                ...
                this.checkAndSetValueBooleanAsButton(this.getStatePrefix(this.currentHomeId, "Calculations", "GetBestTime"), false, "Start calculate best time"),
            ...
            await this.checkAndSetValueBoolean(this.getStatePrefix(this.currentHomeId, "Features", "RealTimeConsumptionEnabled"), currentHome.features.realTimeConsumptionEnabled);
        }
        return homeIdList;
    }
